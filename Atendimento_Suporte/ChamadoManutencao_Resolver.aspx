<%@ Page Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ChamadoManutencao_Resolver.aspx.vb" Inherits="SGM_WEB.ChamadoManutencao_Resolver" %>
...
<link href="../Padrao.css" rel="stylesheet">
    ...
    <asp:Panel ID="Panel3" runat="server" Height="877px" Width="1017px">
        ...
        <asp:UpdatePanel ID="Update" runat="server">
            <ContentTemplate>
                <div class="container">
                        <asp:Label ID="lblddmed" runat="server" Text="Adicionar tipo de manutenção" Enabled="False" Font-Bold="True"></asp:Label><br />
                        <asp:TextBox ID="txtmanu" runat="server" Width="499px" Height="24px" CssClass="boxText" DefaultButton="btnaddmanu"></asp:TextBox>&nbsp;
                                <asp:Button ID="btnaddmanu" Text="Adicionar" runat="server" Font-Size="SMALL" Height="32px" Width="102px" CssClass="BtnStyle" /><br /><br />
