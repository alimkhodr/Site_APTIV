<%@ Page Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ChamadoTI.aspx.vb" Inherits="SGM_WEB.ChamadoTI" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:Panel ID="Panel3" runat="server" Height="855px" Width="1011px">
        <div class="aviso">
            <asp:Image ID="Image1" runat="server" Height="35px" ImageUrl="~/Images/aviso.png" Width="35px" />
            &nbsp; &nbsp;<asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="medium">Página destinada apenas para chamados da manufatura e SGM, para outros assuntos use este link:<br /><a href="http://aptiv.service-now.com" target="_blank">aptiv.service-now.com</a>ou ligue: 0800 721 2014</asp:Label>
        </div>
        <br />
        <div class="title">
