Public Class ChamadoTI
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            conectabdnew()
            cbotipo.Items.Add("")
            comandoSQL.CommandText = "Select NOME_CHAMADO from TAB_CHAMADO_TI_TIPO"
    ...
    Protected Sub cmdsalvar_Click(sender As Object, e As EventArgs) Handles cmdsalvar.Click
        ...
        conectabdnew()
        comandoSQL.CommandText = "INSERT INTO TAB_CHAMADO_TI VALUES(@LOCAL, @TIPO, @REGISTRO_CHAMADO, @DESCRICAO, GETDATE(), NULL, NULL, NULL, NULL)"
    ...
    Private Sub PreencherChamado()
        ...
        conectabdnew()
        comandoSQL.CommandText = "SELECT TAB_CHAMADO_TI.*, FUNCIONARIO.FUN_NOME FROM TAB_CHAMADO_TI INNER JOIN FUNCIONARIO ON FUNCIONARIO.FUN_REGISTRO = TAB_CHAMADO_TI.REGISTRO_CHAMADO WHERE TAB_CHAMADO_TI.DATA_RESOLUCAO IS NULL AND REGISTRO_CHAMADO = @REGISTRO_CHAMADO"
        comandoSQL.Parameters.AddWithValue("@REGISTRO_CHAMADO", User.Identity.Name)
        objDataReader = comandoSQL.ExecuteReader
        If objDataReader.HasRows Then
